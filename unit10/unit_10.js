...
let ar2 = ['Java Script ', 2,0 , true] // переменную обьявляем здесь!!!!
...
function f17() {
    let count = 0;
for (let i = count; i < ar17.length; i++){
    if (ar17[i] > 3 ){
        count++;
    }
}
