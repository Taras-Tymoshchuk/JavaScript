...
function f8() {
    let div8 = document.querySelector('.out-8')
        div8.innerHTML = "<input type = 'text' class = 'i-81'></input> <button  class = 'b-81'>";
...
function f81 () {
 let div = document.querySelector('.out-81');
...
function f16() {
    ...
    div.innerHTML = document.querySelector('.s-16').value;
}
