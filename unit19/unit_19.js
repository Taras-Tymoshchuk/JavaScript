...
function t3() {
   let size = document.querySelector('.div-3').style.width = w3 + "px";
   w3 += 5;
   document.querySelector('.out-3').innerHTML = size;
...
document.querySelector('.div-15').textContent = val;
val++
}
...
document.querySelector('.out-18').textContent = div.clientWidth;
}
...
let load = document.querySelector('#value');
function t20() {
