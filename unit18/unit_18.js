...
function t2() {
    let a2 = [4, 5, 6, 7, 12, 34, 56, 78, 90, 11];
    a2.forEach(elem => {
        a2_res.push(elem / 2);
    });
...
function t4() {
    let a4 = document.querySelectorAll('.task-4').forEach(elem =>{
...
function t6() {
    ...
    a6_res = document.querySelector('.out-6').innerHTML = str6.split('');
     console.log(a6_res);
}
...
function t7() {
    ...
    a7_res = document.querySelector('.out-7').innerHTML = str7.split(" ");
    console.log(a7_res)
}
...
function t8() {
    a8 = [1,2,66,77,15];
    a8_res = document.querySelector('.out-8').innerHTML = a8.join('-');
}
