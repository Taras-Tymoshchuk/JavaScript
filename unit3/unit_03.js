...
function f4(){
let userBirth = +document.querySelector('.i-4').value;
let out = document.querySelector('.out-4');
let currentYear = 2021;
let dif = (currentYear - userBirth);
...
function f9(){
let flat = document.querySelector('.i-9').value;
...
function f10(){
    let val = document.querySelector('.s-100');
    let out = document.querySelector('.out-10');
    out.innerHTML = val.value;
...
function f11(){
let sel = document.querySelector('.s-110');
...
// тип string. при вводе чисел тип не выводит
...
// данные из input всегда дают string
let i130 = document.querySelector('.i-130');
function f13(){
    let v = i130.value;//let v = +i130.value- так будет number
