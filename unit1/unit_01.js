...
document.querySelector('.four').innerHTML+='<h4>Some Title</h4> <p>Some paragraf</p>';
...
div16.innerHTML = x1 + x2; // Произошла конкатенация строк
...
console.log (d1); // Передает в консоль весь HTML контейнер
...
console.log(d2);
d2 = 5;
console.log(d2);// Перезаписало переменную
...
let divS3 = document.querySelector('.s3');
 console.log(divS3);// весь HTML контейнер s3
 divS3 = document.querySelector('.s4');
 console.log(divS3);// контейнер s4
...
// document.querySelector('body').innerHTML = ''; // экран стал белым. для секреток пойдет. 